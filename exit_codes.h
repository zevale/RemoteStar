...
enum class ExitCodes {
    ...
    FAILURE_JOB_FILE_NUM_PRISM_LAYER_INVALID           , // Job file: <num_prism_layers> >= 1
    ...
    FAILURE_JOB_FILE_MACH_NUMBER_EMPTY                 , // Job file: <reference_density> is empty
    FAILURE_JOB_FILE_MACH_NUMBER_MISSING               , // Job file: <reference_density> is missing
